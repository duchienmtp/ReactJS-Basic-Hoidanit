  ...
  return (
    <div className="youtube-search-container">
      ...
      <div className="yt-result" key={item.id}>
        ...
        <div className="right">
          <div className="title">
            Tương Lai Của Dev React.JS | Nên Học Gì Để Không Thất Nghiệp Khi
            React Thay Đổi ?
          </div>
          ...
          <div className="description">
            Vào tháng 3, 2023, React chính thức có ngôi nhà mới với địa chỉ
            https://react.dev, nhà cũ reactjs.org đã được đổi thành ...
          </div>
        </div>
      </div>
    </div>
